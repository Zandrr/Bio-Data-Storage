...
<body>
<?php
    echo "<table summary=\"none\" class=\"main_table\" cellpadding=\"5\"><tr><td valign=\"top\"><strong>MD5 password encrypter</strong></td></tr><tr><td valign=\"top\">";
    echo $login_messages_ar['pwd_explain_text'];
    echo "<form action=\"pwd.php\" name=\"pwd_gen\" id=\"pwd_gen\" method=\"POST\">";
    echo "<br /><input type=\"text\" name=\"pwd\" name=\"pwd\" value=\"";
    if (isset($_POST['pwd'])) {
    	echo $_POST['pwd'];
    } // end if
    echo "\" size=\"40\" /><br />";
    echo "<input type=\"submit\" value=\"".$login_messages_ar['pwd_encrypt_button_text']."\" />";
    echo "</form>";
    if(isset($_POST['pwd'])){
    	$encrypted = md5($_POST['pwd']);
    	echo "<form name=\"encrypter\" id=\"encrypter\">";
    	echo "<br /><input type=\"text\" name=\"encrypted\" id=\"encrypted\" value=\"$encrypted\" size=\"40\" /><br />";
    	echo "<input type=\"button\" name=\"encrypt-it\" id=\"encrypt-it\" value=\"".$login_messages_ar['pwd_register_button_text']."\" onclick=register_pwd('".$encrypted."') />";
    	echo "</form>";
