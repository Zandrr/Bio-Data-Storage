...
include ("header.php");
 // finish header
/////////////////////////////////////////////////////////////////////////
echo ('<span style="color:#dcdcdc;">'.$log_status.'<a>'. $date); ?></a> || <a href="help/help.htm#what" onclick="return popitup('help/help.htm#what')">What is this</a> || <a href="help/help.htm#how" onclick="return popitup('help/help.htm#how')">How do I use it</a> || <a href="
<?php
...
<td style="text-align:left; align:left; valign:middle; color:#black;"><span style="background-color:#ffffff;">&larr; '.$value[2].'</span></td>
</tr>';
}
echo ($to_show);
...
echo ("</table><p style=\"color: #black;\">".$to_show." in database</p>");
/////////////////////////////////////////////////////////////////////////
include ("footer.php");
?>
